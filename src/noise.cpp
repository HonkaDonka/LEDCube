 ...
 * on www.noisemachine.com
 *
 * Converted to C++ by MaltWhiskey
...
float Noise::noise1(float x)
{
  ...
  // 2sd = 2.80, below 2sd or above 2sd = 95% of the noise surface
  // scale all between -2sd and +2sd to -0.5 and 0.5 and add 0.5
  n0 = 0.5f + ((LERP(s, n0, n1)) * 0.50f / 2.80f);
  if (n0 < 0)
    n0 = 0;
  else if (n0 > 1)
    n0 = 1;
...
float Noise::noise2(float x, float y)
{
  ...
  // 2sd = 0.94, below 2sd or above 2sd = 95% of the noise surface
  // scale all between -2sd and +2sd to -0.5 and 0.5 and add 0.5
  n0 = 0.5f + ((LERP(s, n0, n1)) * 0.50f / 0.94f);
  if (n0 < 0)
    n0 = 0;
  else if (n0 > 1)
    n0 = 1;
...
float Noise::noise3(float x, float y, float z)
{
  ...
  // 2sd = 0.54, below 2sd or above 2sd = 95% of the noise surface
  // scale all between -2sd and +2sd to -0.5 and 0.5 and add 0.5
  n0 = 0.5f + ((LERP(s, n0, n1)) * 0.50f / 0.54f);
  if (n0 < 0)
    n0 = 0;
  else if (n0 > 1)
    n0 = 1;
...
float Noise::pnoise3(float x, float y, float z, int px, int py, int pz)
{
  ...
  // sd = 0.54, below 2sd or above 2sd = 95% of the noise surface
  // scale all between -2sd and +2sd to -0.5 and 0.5 and add 0.5
  n0 = 0.5f + ((LERP(s, n0, n1)) * 0.50f / 0.54f);
  if (n0 < 0)
    n0 = 0;
...
float Noise::noise4(float x, float y, float z, float w)
{
  ...
  // 2sd = 0.58, below 2sd or above 2sd = 95% of the noise surface
  // scale all between -2sd and +2sd to -0.5 and 0.5 and add 0.5
  n0 = 0.5f + ((LERP(s, n0, n1)) * 0.50f / 0.58f);
  if (n0 < 0)
    n0 = 0;
  else if (n0 > 1)
    n0 = 1;
